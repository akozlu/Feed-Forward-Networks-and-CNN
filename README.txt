...
A simple one-hidden  layer  neural  network. Input image is a 3072x1 vector. The hidden layer has 1024 neurons followed by sigmoid activation function. The last layer outputs 10 probabilities for each class.
